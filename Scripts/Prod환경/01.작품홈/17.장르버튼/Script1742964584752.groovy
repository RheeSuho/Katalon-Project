...
WebUI.click(findTestObject('Object Repository/Prod환경/Home/06.작품홈/17.장르버튼'))

WebUI.click(findTestObject('Object Repository/Prod환경/Home/06.작품홈/18.로판장르버튼'))

WebUI.click(findTestObject('Object Repository/Prod환경/Home/06.작품홈/19.BM버튼'))

WebUI.click(findTestObject('Object Repository/Prod환경/Home/06.작품홈/20.WUF버튼'))

WebUI.click(findTestObject('Object Repository/Prod환경/Home/06.작품홈/21.정렬버튼'))

WebUI.click(findTestObject('Object Repository/Prod환경/Home/06.작품홈/22.최신순버튼'))
