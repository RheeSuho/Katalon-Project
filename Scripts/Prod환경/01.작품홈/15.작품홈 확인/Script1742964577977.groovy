...
WebUI.verifyElementVisible(findTestObject('Prod환경/Home/06.작품홈/14.작가영역'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Prod환경/Home/06.작품홈/15.Details영역'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Prod환경/Home/06.작품홈/16-1.추천작품'), FailureHandling.STOP_ON_FAILURE)
