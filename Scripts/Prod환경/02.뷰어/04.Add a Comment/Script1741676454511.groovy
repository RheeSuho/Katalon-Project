...
WebUI.click(findTestObject('Object Repository/Prod환경/Home/07.뷰어/06.Add a comment'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Prod환경/Home/07.뷰어/03.회차리스트버튼'))
