...
WebUI.click(findTestObject('Object Repository/Prod환경/Home/07.뷰어/40. Support 버튼'))

WebUI. delay (3)

WebUI.click(findTestObject('Object Repository/Prod환경/Home/07.뷰어/41. 서포트 X 버튼'))
