...
for (int i = 0; i < 11; i++) {
	...
	WebUI.verifyElementVisible(findTestObject('Object Repository/Prod환경/Home/07.뷰어/07.추천작품'))
}

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/Prod환경/Home/07.뷰어/28.소설-추천작품섬네일'))
