...
WebUI.callTestCase(findTestCase('Test Cases/CallTest용도/Novel-뷰어진입'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Prod환경/Home/07.뷰어/27.Accept버튼'))


WebUI.click(findTestObject('Object Repository/Prod환경/Home/07.뷰어/15.회차리스트버튼'))
